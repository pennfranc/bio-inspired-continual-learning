...
grid = {
    ...
    ### Network options ###
    'size_hidden': ['"100"', '"100,100"', '"200,200"'],
    'hidden_activation': ['relu', 'tanh', 'sigmoid'],

    ### Training options ###
    'initialization': ['xavier', 'xavier_normal'],
    'optimizer': ['Adam'],
    'adam_beta1': [0.9, 0.99, 0.999],
    'adam_beta2': [0.9, 0.99, 0.999],
    'batch_size': [32, 128, 256],
    'lr': [1e-4, 1e-3, 5e-3],
    'clip_grad_norm' : [-1, 1, 100],
}
...
_SUMMARY_KEYWORDS = get_summary_keys(classification=True)
